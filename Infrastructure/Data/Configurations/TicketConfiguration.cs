...
namespace Infrastructure.Data.Configurations
{
    public class TicketConfiguration : IEntityTypeConfiguration<Ticket>
    {
        public void Configure(EntityTypeBuilder<Ticket> builder)
        {
            ...
            builder.Property(t => t.TotalAmount).HasPrecision(18, 2).IsRequired();
            builder.Property(t => t.EmployerCoverage).HasPrecision(18, 2).IsRequired();
            builder.Property(t => t.AmountToPay).HasPrecision(18, 2).IsRequired();
